...
| OSC-Command                   | OSC-Type        | Description                                                                             | behringer-mixer Endpoint Path                                        | Endpoint Type   | Endpoint Class           |                  R / W                  |
|:------------------------------|:----------------|:----------------------------------------------------------------------------------------|:---------------------------------------------------------------------|:----------------|:-------------------------|:---------------------------------------:|
...
| `/$stat/time` / `/$stat/date` | String / String | Clock time (depending on date format) [RO] / Clock date (depending on date format) [RO] | `mixer.status.current_time`                                          | ComplexEndpoint | WINGDatetimeEndpoint     |        :white_check_mark: / :x:         |
...
| `/cfg/mon/1/eqbdtrim`         | Float           | Monitor bus 1 band solo trim (dB)                                                       | `mixer.general_configuration.monitor_bus[1].band_solo_trim`          | Endpoint        | WINGFloatEndpoint        | :white_check_mark: / :white_check_mark: |
...
| `/cfg/solo`                   | Node            | Solo config node                                                                        | `mixer.general_configuration.solo`                                   | Component       | WINGSoloConfiguration    |                  - / -                  |
| `/cfg/solo/mode`              | String          | Solo mode                                                                               | `mixer.general_configuration.solo.mode`                              | Endpoint        | WINGStringEnumEndpoint   | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/mon`               | String          | Solo monitor                                                                            | `mixer.general_configuration.solo.monitor`                           | Endpoint        | WINGStringEnumEndpoint   | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/mute`              | Integer         | Solo mute                                                                               | `mixer.general_configuration.solo.mute`                              | Endpoint        | WINGBoolEndpoint         | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/$dim`              | Integer         | Solo dim off / on                                                                       | `mixer.general_configuration.solo.dim`                               | Endpoint        | WINGBoolEndpoint         | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/$mono`             | Integer         | Solo mono off / on                                                                      | `mixer.general_configuration.solo.mono`                              | Endpoint        | WINGBoolEndpoint         | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/$flip`             | Integer         | Solo flip                                                                               | `mixer.general_configuration.solo.flip`                              | Endpoint        | WINGBoolEndpoint         | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/chtap`             | String          | Solo channel tap                                                                        | `mixer.general_configuration.solo.channel_tap`                       | Endpoint        | WINGStringEnumEndpoint   | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/bustap`            | String          | Solo bus tap                                                                            | `mixer.general_configuration.solo.bus_tap`                           | Endpoint        | WINGStringEnumEndpoint   | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/maintap`           | String          | Solo main tap                                                                           | `mixer.general_configuration.solo.main_tap`                          | Endpoint        | WINGStringEnumEndpoint   | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/mtxtap`            | String          | Solo matrix tap                                                                         | `mixer.general_configuration.solo.matrix_tap`                        | Endpoint        | WINGStringEnumEndpoint   | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/srcsolo`           | String          | Source Solo Enable                                                                      | `mixer.general_configuration.solo.source_solo.mode`                  | Endpoint        | WINGStringEnumEndpoint   | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/$srcsolo`          | Integer         | Source Solo                                                                             | `mixer.general_configuration.solo.source_solo.solo`                  | Endpoint        | WINGBoolEndpoint         | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/$srcsgrp`          | Integer         | Source Solo Group                                                                       | `mixer.general_configuration.solo.source_solo.source_group`          | Endpoint        | WINGSourceGroupEndpoint  | :white_check_mark: / :white_check_mark: |
| `/cfg/solo/$srcsin`           | Integer         | Source Solo In                                                                          | `mixer.general_configuration.solo.source_solo.source_index`          | Endpoint        | WINGIntEndpoint          | :white_check_mark: / :white_check_mark: |
